  ...
  <div>
    ...
    <div>
      <div class="overflow-hidden rounded-full bg-gray-200">
        <div class="h-2 w-6/6 rounded-full bg-blue-500"></div>
      </div>
      ...
      <ol class="mt-4 grid grid-cols-4 text-sm font-medium text-gray-500">
        <li class="flex items-center justify-start text-blue-600 sm:gap-1.5">
          <span class="hidden sm:inline"> รับเรื่อง </span>
        ...
        <li class="flex items-center justify-center text-blue-600 sm:gap-1.5">
          <span class="hidden sm:inline"> กำลังซ่อม </span>
        ...
        <li class="flex items-center justify-end sm:gap-1.5">
          <span class="hidden sm:inline"> จ่ายเงิน </span>
        ...
        <li class="flex items-center justify-end sm:gap-1.5">
          <span class="hidden sm:inline"> เรียบร้อย </span>
